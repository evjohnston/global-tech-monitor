...
export const SEED: Entry[] = [
  ...
  {
    id: "seed-eeroq-wonderlake-2026-07",
    stage: "scaling", country: "US", provenance: "seeded", source: "milestone",
    title: "EeroQ demonstrates electron shuttling on superfluid helium using a commercial CMOS \"Wonder Lake\" chip with just 14 control lines addressing 128 independent channels for all-to-all qubit routing",
    org: "EeroQ", date: "2026-07-10",
    url: "https://quantumcomputingreport.com/eeroq-validates-cmos-controlled-electron-shuttling-on-superfluid-helium-for-all-to-all-qubit-routing/",
  },
  {
    id: "seed-nvidia-ising-decoder-2026-07",
    stage: "scaling", country: "US", provenance: "seeded", source: "milestone",
    title: "NVIDIA's open-source Ising Decoder ColorCode 1 Fast cuts logical error rates by up to 347.7 times and decodes 7.3 times faster than the prior Chromobius decoder for color-code quantum error correction",
    org: "NVIDIA", date: "2026-07-13",
    url: "https://quantumcomputingreport.com/nvidia-launches-open-ising-decoder-architecture-to-suppress-quantum-color-code-error-rates-by-347x/",
  },
  {
    id: "seed-logicalqubit-agate165-2026-07",
    stage: "scaling", country: "CN", provenance: "seeded", source: "milestone",
    title: "Hangzhou-based Logical Qubit Technology unveils its AGate-165 superconducting chip, cutting qubit readout time to 600 nanoseconds from 2 microseconds on its prior generation",
    org: "Logical Qubit Technology", date: "2026-07-09",
    url: "https://thequantuminsider.com/2026/07/14/logical-qubit-technology-launches-quantum-cloud-platform-at-quantum-day-2026/",
  },
  {
    id: "seed-quix-carina-2026-07",
    stage: "scaling", country: "NL", provenance: "seeded", source: "milestone",
    title: "QuiX Quantum delivers the core hardware of \"Carina,\" the first universal photonic quantum computing architecture built to run at room temperature in a standard data-center rack, to Germany's DLR Quantum Computing Initiative",
    org: "QuiX Quantum", date: "2026-07-14",
    url: "https://thequantuminsider.com/2026/07/14/quix-quantum-announces-photonic-quantum-computing-architecture-for-commercial-deployment/",
  },
  {
    id: "seed-google-willow-rl-2026-07",
    stage: "scaling", country: "US", provenance: "seeded", source: "milestone",
    title: "Google Quantum AI cuts its Willow processor's logical error rate by up to 31% using a reinforcement-learning agent that continuously recalibrates hardware controls during error-correction cycles without pausing the computation",
    org: "Google Quantum AI", date: "2026-07-10",
  ...
  {
    id: "seed-quantinuum-anyons-2026-07",
    stage: "scaling", country: "US", provenance: "seeded", source: "milestone",
    title: "Quantinuum and academic partners entangle 54 physical qubits on its H2 trapped-ion processor to realize the first universal topological gate set built from braiding and fusing non-Abelian anyons",
    org: "Quantinuum", date: "2026-07-17",
    url: "https://thequantuminsider.com/2026/07/17/braided-exotic-particles-could-build-reliable-universal-quantum-computers/",
  },
  {
    id: "seed-ibm-nighthawkr2-reset-2026-07",
    stage: "scaling", country: "US", provenance: "seeded", source: "milestone",
    title: "IBM's redesigned qubit reset on its 120-qubit Nighthawk r2 processor cuts reset time to 25 nanoseconds from 200 microseconds, letting circuits run up to 100,000 per second, a 25-fold throughput gain",
    org: "IBM Quantum", date: "2026-07-17",
    url: "https://quantumcomputingreport.com/ibm-improves-qubit-reset-by-25x-and-releases-qiskit-v2-5/",
  },
  {
    id: "seed-nordquantique-spam-2026-07",
    stage: "scaling", country: "CA", provenance: "seeded", source: "milestone",
    title: "Sherbrooke-based Nord Quantique cuts state-preparation-and-measurement errors on its bosonic grid-state qubit below 0.1%, a roughly 100-fold improvement that brings GKP qubits to parity with leading transmon platforms",
    org: "Nord Quantique", date: "2026-07-13",
    url: "https://thequantuminsider.com/2026/07/13/ord-quantique-quantum-error-correction-sub-01-percent-spam-errors/",
  },
  {
    id: "seed-qutech-tuna17-2026-07",
    stage: "scaling", country: "NL", provenance: "seeded", source: "milestone",
    title: "QuTech's Delft-built Tuna-17, a 17-qubit superconducting processor with 24 tunable couplers in a \"ninja-star\" layout, goes live on the Quantum Inspire cloud platform for open public access",
    org: "QuTech", date: "2026-07-10",
    url: "https://thequantuminsider.com/2026/07/10/quantum-inspire-adds-new-open-architecture-quantum-processor-tuna-17/",
  },
  ...
  // NSF grants (live, source: "grant") cover public research funding;
  // these are real, hand-verified private capital raises (source:
  // "funding-round") by quantum computing startups, added 2026-07-24 —
  // see CLAUDE.md's "Public vs. private investment over time" section for
  // why these are never summed into fundingByCountry/periodFunding's
  // NSF-only total. Excludes already-public companies (IonQ, Rigetti,
  // D-Wave, IBM, Alphabet, Honeywell) — their capital-raise story is in
  // the public-markets panel and SEC EDGAR R&D-spend chart instead.
  {
    id: "seed-quantinuum-equity-2024",
    stage: "investment", country: "US", provenance: "seeded", source: "funding-round",
    title: "Quantinuum raises $300 million equity round led by JPMorgan Chase at a $5 billion pre-money valuation",
    org: "Quantinuum", date: "2024-01",
    url: "https://www.quantinuum.com/press-releases/honeywell-announces-the-closing-of-300-million-equity-investment-round-for-quantinuum-at-5b-pre-money-valuation",
    amountUsd: 300000000,
  },
  {
    id: "seed-diraq-seriesa2-2024",
    stage: "investment", country: "AU", provenance: "seeded", source: "funding-round",
    title: "Diraq raises $15 million Series A-2 led by Quantonation to advance fault-tolerant quantum computing",
    org: "Diraq", date: "2024-02",
    url: "https://www.quantonation.com/2024/02/12/diraq-secures-usd-15-million-in-series-a-2-funding-to-advance-fault-tolerant-quantum-computing-development/",
    amountUsd: 15000000,
  },
  {
    id: "seed-qblox-seriesa-2024",
    stage: "investment", country: "NL", provenance: "seeded", source: "funding-round",
    title: "Qblox raises $26 million Series A led by Quantonation and Invest-NL Deep Tech fund",
    org: "Qblox", date: "2024-06",
    url: "https://qblox.com/newsroom/qblox-secures-series-a-funding-quantum-control-stack-development",
    amountUsd: 26000000,
  },
  {
    id: "seed-riverlane-seriesc-2024",
    stage: "investment", country: "GB", provenance: "seeded", source: "funding-round",
    title: "Riverlane raises $75 million Series C led by Planet First Partners for quantum error correction",
    org: "Riverlane", date: "2024-08",
    url: "https://news.crunchbase.com/venture/quantum-computing-riverlane-funding-raise/",
    amountUsd: 75000000,
  },
  {
    id: "seed-qctrl-seriesb-2024",
    stage: "investment", country: "AU", provenance: "seeded", source: "funding-round",
    title: "Q-CTRL increases its Series B to $113 million, led by GP Bullhound, a global quantum-technology fundraising record",
    org: "Q-CTRL", date: "2024-10",
  ...
  {
    id: "seed-seeqc-seriesa-ext-2025",
    stage: "investment", country: "US", provenance: "seeded", source: "funding-round",
    title: "SEEQC raises $30 million Series A extension co-led by Booz Allen Ventures and NordicNinja",
    org: "SEEQC", date: "2025-01",
    url: "https://techcrunch.com/2025/01/14/with-30-million-in-new-funding-seeqc-thinks-chips-are-key-to-building-useful-quantum-computing/",
    amountUsd: 30000000,
  },
  {
    id: "seed-alicebob-seriesb-2025",
    stage: "investment", country: "FR", provenance: "seeded", source: "funding-round",
    title: "Alice & Bob raises $104 million Series B led by Future French Champions, AVP, and Bpifrance",
    org: "Alice & Bob", date: "2025-01",
  ...
  {
    id: "seed-quantummachines-seriesc-2025",
    stage: "investment", country: "IL", provenance: "seeded", source: "funding-round",
    title: "Quantum Machines raises $170 million Series C led by PSG Equity",
    org: "Quantum Machines", date: "2025-02",
    url: "https://www.quantum-machines.co/press-release/quantum-machines-raises-170-million-in-series-c-funding/",
    amountUsd: 170000000,
  },
  {
    id: "seed-multiversecomputing-seriesb-2025",
    stage: "investment", country: "ES", provenance: "seeded", source: "funding-round",
    title: "Multiverse Computing raises $215 million Series B led by Bullhound Capital",
    org: "Multiverse Computing", date: "2025-06",
    url: "https://techcrunch.com/2025/06/12/multiverse-computing-raises-215m-for-tech-that-could-radically-slim-ai-costs/",
    amountUsd: 215000000,
  },
  {
    id: "seed-infleqtion-seriesc-2025",
    stage: "investment", country: "US", provenance: "seeded", source: "funding-round",
    title: "Infleqtion raises $100 million Series C backed by Glynn Capital, Counterpoint Global, and SAIC",
    org: "Infleqtion", date: "2025-06",
    url: "https://infleqtion.com/infleqtion-raises-100m-to-scale-atom-based-quantum-solutions-for-national-security-and-next-generation-intelligent-systems/",
    amountUsd: 100000000,
  },
  {
    id: "seed-psiquantum-seriese-2025",
    stage: "investment", country: "US", provenance: "seeded", source: "funding-round",
    title: "PsiQuantum raises $1 billion Series E, led by BlackRock, Temasek, and Baillie Gifford, at a $7 billion valuation",
    org: "PsiQuantum", date: "2025-09",
    url: "https://www.psiquantum.com/news-import/psiquantum-1b-fundraise",
    amountUsd: 1000000000,
  },
  {
    id: "seed-quera-seriesb-2025",
    stage: "investment", country: "US", provenance: "seeded", source: "funding-round",
    title: "QuEra Computing expands its $230 million Series B, with Google Quantum AI, SoftBank Vision Fund 2, and NVentures among the investors",
    org: "QuEra Computing", date: "2025-09",
    url: "https://www.prnewswire.com/news-releases/quera-expands-230-million-financing-round-advancing-quantum-accelerated-supercomputing-302550112.html",
    amountUsd: 230000000,
  },
  {
    id: "seed-iqm-seriesb-2025",
    stage: "investment", country: "FI", provenance: "seeded", source: "funding-round",
    title: "IQM Quantum Computers raises $320 million Series B led by Ten Eleven Ventures, becoming a unicorn",
    org: "IQM Quantum Computers", date: "2025-09",
    url: "https://www.worldfund.vc/articles/iqm-quantum-computers-raises-over-300m-series-b-funding-round",
    amountUsd: 320000000,
  },
  {
    id: "seed-photonic-round-2026",
    stage: "investment", country: "CA", provenance: "seeded", source: "funding-round",
    title: "Photonic Inc raises $130 million (first close), led by Planet First Partners with Royal Bank of Canada and TELUS",
    org: "Photonic Inc.", date: "2026-01",
    url: "https://photonic.com/news/photonic-raises-180m/",
    amountUsd: 130000000,
  },
  {
    id: "seed-atomcomputing-seriesc-2026",
    stage: "investment", country: "US", provenance: "seeded", source: "funding-round",
    title: "Atom Computing raises $100 million Series C led by Third Point Ventures",
    org: "Atom Computing", date: "2026-06",
    url: "https://www.prnewswire.com/news-releases/atom-computing-raises-more-than-300-million-to-accelerate-deployment-of-fault-tolerant-neutral-atom-quantum-computers-302800832.html",
    amountUsd: 100000000,
  },
];
